'''Crear un programa que permita al usuario elegir un candidato por el cual votar. Las posibilidades son: candidato A por el partido 
...
opcion = input("Ingresa la opción de tu candidato (ABC): ")

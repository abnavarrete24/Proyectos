#Ejercicio 2
#Con el siguiente diccionario, debes crear un programa que pregunte al usuario por un número; el programa debe 
...
if diccionario[OpcionJugador] in diccionario:
